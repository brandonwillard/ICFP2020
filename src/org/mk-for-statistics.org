#+TITLE: miniKanren as a Tool for Symbolic Statistical Computation
...
is used.  Just like the optimization system in Theano, the graph of a PyMC model
...
methods essentially falls within the domain of term rewriting
...
* Discussion
- Mention non-statistical symbolic computation with miniKanren in Python (e.g. like the Hy example in [[citet:WillardReadableStringsRelational2018b]])
- Look into the cross-overs with "inference engines" (e.g. the Rete algorithm)
